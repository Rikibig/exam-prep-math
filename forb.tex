...
\opg{Overvej hvorfor tangens er $\frac{\sin}{\cos}$.}
...
\opg{Kan alle følger kombineres med samme idé? \textit{Hint:} Overvej hvis $x$
beskrives ved $n^2$.}
...
\opg{Hvorfor er der kun et stationært punkt, som er et minimum?}
...
standardfunktionerne er kontinuerte.}
...
\opg{Overvej hvornår dette bevis ikke gælder.}
...
\begin{tcolorbox}
	\section{Differential- og integralregning}
	Er tilsyneladende ufærdig. % TODO
	\tcblower
	\begin{enumerate}
		\item Giv en præsentation af en selvvalgt del af teorien for 
			differential- og integralregning
...
blot findes stamfølgen til $g^x$. Det er $\frac{1}{g-1} g^x$.

\opg{Vis at stamfølgen til $g^x$ er $\frac{1}{g-1}g^x$.}
...
\begin{definition}{Tæthedsfunktion}{thickfunc}
	...
	ved intervallet $[a; b]$ er en tæthedsfunktion hvis og kun hvis den
	opfylder
	\[
		f(x) \ge 0 \qquad \text{og} \qquad \int_a^b f(x) \dx = 1.
	\] 
